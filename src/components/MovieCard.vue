<template>
  <div
    class="movie-card group h-full flex flex-col bg-white/5 rounded-xl shadow-lg overflow-hidden min-h-[420px] max-h-[420px]"
  >
    <div class="relative">
      <img
    ...
    <div class="p-4 flex flex-col flex-1 justify-between">
      ...
      <p class="text-gray-400 text-sm mb-3 line-clamp-2 min-h-[40px]">
        {{ movie.overview || ' ' }}
      </p>
