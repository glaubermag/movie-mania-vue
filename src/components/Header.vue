    ...
    <header class="sticky top-0 z-50 w-full glass-effect">
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between w-full">
          ...
          <!-- Botões do topo no mobile: apenas favoritos e carrinho -->
          <div class="flex items-center space-x-2 md:hidden ml-2">
            <button
              @click="toggleFavorites"
              class="relative text-white hover:text-primary"
        ...
        <!-- Menu Mobile -->
        <!-- Removido o menu lateral mobile -->
      </div>
    </header>
