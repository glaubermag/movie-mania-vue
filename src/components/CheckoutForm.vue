        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          <div>
            ...
            <input
              ...
              :class="[
                'input-base',
                'bg-zinc-800 text-white placeholder-black border border-zinc-600 focus:outline-none focus:ring-2 focus:ring-orange-400',
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              class="input-base bg-zinc-800 text-white placeholder-black border border-zinc-600 focus:outline-none focus:ring-2 focus:ring-orange-400"
            />
          </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
